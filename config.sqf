...
cityListLimit = compileFinal preprocessFileLineNumbers "mapConfig\townsLimit.sqf"; // Town limitation for Spawns such as Assasins, Spetznas, SpecOps, Delta Force, etc..
citylistNoRanObj = compileFinal preprocessFileLineNumbers "mapConfig\townsNoRanObj.sqf"; //no Random Objects in Towns
cityListMISCITY = compileFinal preprocessFileLineNumbers "mapConfig\missioncity.sqf";
