...
A3W_hcObjCaching = 0;              // Enable headless client object caching (0 = no, 1 = yes)
...
A3W_hcCleanup = 0;              // Enables Cleanup on HC (1 or 2)
A3W_hcCleanupID = 1;            // ID of HC for Cleanup
A3W_hcScript = 0;              // Enables Scripting HC (1 or 2)
A3W_hcScriptID = 1;            // ID of HC for Scripts
...
A3W_extraMissionDelay = 7*60;       // Time in seconds between Side Missions
A3W_extraMissionTimeout = 30*60;    // Time in seconds that a Side Mission will run for, unless completed
A3W_specialMissionDelay = 25*60;       // Time in seconds between Side Missions
A3W_specialMissionTimeout = 45*60;    // Time in seconds that a Side Mission will run for, unless completed
