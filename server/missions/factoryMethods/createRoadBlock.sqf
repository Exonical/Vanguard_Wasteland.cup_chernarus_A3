...
private _objList = call compile preprocessFileLineNumbers format ["server\missions\roadBlocks\%1.sqf", _fileName];
private _objs = [];

{
	...
	_objPos = _pos vectorAdd ([_objPos, -(_dir)] call BIS_fnc_rotateVector2D);
	private _obj = createVehicle [_objName, _objPos, [], 0, "CAN_COLLIDE"];
