...
_setupObjects =
{
	...
	_createVehicle =
	{
		...
		switch (true) do
		{
			case (_type isKindOf "O_T_LSV_02_armed_F"):
			{
				[_vehicle, "client\images\vehicleTextures\weed.paa", [0]] call applyVehicleTexture; 
			};
		};
	...
	_missionHintText = format ["Drugs runners driving a <t color='%2'>%1</t> are moving drugs around. Stop them quickly!", _vehicleName, sideMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "You have stopped the drugs runners! The drugs are yours to take!";
};
