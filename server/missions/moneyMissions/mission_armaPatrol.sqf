...
// ******************************************************************************************
//	@file Name: mission_armaPatrol.sqf
...
_setupObjects =
{
	...
	_missionHintText = format ["A convoy containing at least a <t color='%4'>%1</t>, a <t color='%4'>%2</t> and a <t color='%4'>%3</t> is patrolling the country! Stop the patrol and capture the goods and money!", _vehicleName, _vehicleName2, _vehicleName3, moneyMissionColor];
...
_successExec =
{
	...
	for "_x" from 1 to 5 do
	{
		...
		_cash setVariable["cmoney",45000,true];
    ...
    [_box1,"mission_Launchers3"] call fn_refillbox;
