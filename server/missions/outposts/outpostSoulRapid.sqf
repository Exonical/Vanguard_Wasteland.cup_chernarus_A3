...
["Box_FIA_Ammo_F",[2.625,2.875,0],45,{[_this, "mission_Snipers1"] call fn_refillbox;}], // leave crate as-is, disallow damage, lock crate until mission complete.
["O_CargoNet_01_ammo_F",[2.5,2.75,2.78],135,{[_this, "mission_Launchers1"] call fn_refillbox;}] // leave crate as-is, disallow damage, lock crate until mission complete.
