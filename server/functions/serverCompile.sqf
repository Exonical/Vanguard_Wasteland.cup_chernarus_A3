...
//no_log "WASTELAND SERVER - Initializing Server Compile";
...
createMissionCompleteMarker = [_path, "createMissionCompleteMarker.sqf"] call mf_compile;
...
createRandomSoldierF = [_path, "createUnits\createRandomSoldierF.sqf"] call mf_compile;
createRandomSoldierF = [_path, "createUnits\createRandomSoldierZ.sqf"] call mf_compile;
...
createCustomGroupAir = [_path, "createUnits\customGroupAir.sqf"] call mf_compile;
createCustomGroupAir2 = [_path, "createUnits\customGroupAir2.sqf"] call mf_compile;
...
createCustomGroupAirDesert = [_path, "createUnits\customGroupAirDesert.sqf"] call mf_compile;
createcustomGroupHunter = [_path, "createUnits\customGroupHunter.sqf"] call mf_compile;
createcustomGroupPolice = [_path, "createUnits\customGroupPolice.sqf"] call mf_compile;
createcustomGroupGas = [_path, "createUnits\customGroupGas.sqf"] call mf_compile;
