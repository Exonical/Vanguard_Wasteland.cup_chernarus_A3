...
{
	_vehicleID = ([format ["newServerVehicleMOD:%1:%2", call A3W_extDB_ServerID, call A3W_extDB_MapID], 2] call extDB_Database_async) select 0;
...
[format ["updateServerVehicleMOD:%1:", _vehicleID] + _updateValues] call extDB_Database_async;
