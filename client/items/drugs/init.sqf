...
MF_ITEMS_LSD_ICON = "client\items\drugs\icons\lsd.paa";
...
MF_ITEMS_MARIJUANA_ICON = "client\items\drugs\icons\marijuana.paa";
...
MF_ITEMS_COCAINE_ICON = "client\items\drugs\icons\cocaine.paa";
...
MF_ITEMS_HEROIN_ICON = "client\items\drugs\icons\heroin.paa";
