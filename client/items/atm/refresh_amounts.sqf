...
private ["_dialog", "_balance", "_amountInput", "_accDropdown", "_bountyCheckbox", "_feeText", "_totalText", "_bmoney", "_balanceText", "_amount", "_fee", "_feeAmount", "_selAcc", "_bountyChecked"];
