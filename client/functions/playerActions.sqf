...
[player, ["<t color='#00FFFF'>Get in as Gunner</t>", "client\actions\moveInGunner.sqf", [0], 6, true, true, "", "locked cursorTarget != 2 && cursorTarget isKindOf 'B_SAM_System_02_F' && player distance cursorTarget < 10 && isNull gunner cursorTarget"]] call fn_addManagedAction;
[player, ["<t color='#00FFFF'>Get in as Gunner</t>", "client\actions\moveInGunner.sqf", [0], 6, true, true, "", "locked cursorTarget != 2 && cursorTarget isKindOf 'B_AAA_System_01_F' && player distance cursorTarget < 10 && isNull gunner cursorTarget"]] call fn_addManagedAction;
// [player, ["<t color='#00FFFF'>Pull out Gunner 1</t>", "client\actions\pulloutGunner.sqf", [cursorTarget], 6, true, true, "", "!isNull cursorTarget && locked cursorTarget != 2 && (count crew cursorTarget) > 0 && cursorTarget isKindOf 'B_SAM_System_02_F' && player distance cursorTarget < 10"]] call fn_addManagedAction;
