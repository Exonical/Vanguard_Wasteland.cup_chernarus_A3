...
fnc_loadSettings =
{
	...
	if (isNil "_nc_settings") then {
		_nc_settings = [0.5,0.025,3,3,0,1,"60",0.5,"PuristaBold",0,1,0,-0.035,5,1,0,"B1B1","FFFFFF"];
	};
...
fnc_showSettings =
{
	...
	nc_dialog_controls = [
	[1000,"nc_background",[1,"",[0.29375 * safezoneW + safezoneX,0.225 * safezoneH + safezoneY,0.170156 * safezoneW,0.760 * safezoneH],[-1,-1,-1,-1],[0.07,0.07,0.07,1],[-1,-1,-1,-1],"","RscText"],[]],
	...
	[1018,"nc_background3",[1,"",[0.29375 * safezoneW + safezoneX,0.420 * safezoneH + safezoneY,0.170156 * safezoneW,0.035 * safezoneH],[-1,-1,-1,-1],[0.349,0.0,0.0,1],[-1,-1,-1,-1],"","RscText"],[]],
	[1016,"nc_background_title_disable",[1,"DISABLE Compass: set 'A' to the Left.",[0.304062 * safezoneW + safezoneX,0.420 * safezoneH + safezoneY,0.149531 * safezoneW,0.033 * safezoneH],[-1,-1,-1,-1],[0.349,0.0,0.0,1],[-1,-1,-1,-1],"","RscText"],[]],
	...
	[1017,"nc_background2",[1,"",[0.29375 * safezoneW + safezoneX,0.573 * safezoneH + safezoneY,0.170156 * safezoneW,0.03 * safezoneH],[-1,-1,-1,-1],[0.349,0.0,0.0,1],[-1,-1,-1,-1],"","RscText"],[]],
...
fnc_compileCompass = {
  ...
  ///
	...
	_compassNeedle ctrlSetStructuredText parseText format["<t shadow=2><t shadowColor='#ff0000' align='center' size='%1' color='#" + _ncAlpha + _ncColorOption + "'>|</t>", 0.65];
