...
_text = format ["\n\n\nBurying A Dead Body Will Get You $%1, You Can Cancel At Anytime Before It Reaches 100%2 Complete!",_price,"%"];
...
if (_outcome) then
{
	...
	{
		["Someone Dug Up The Dead Body, Reward Removed!", 5] call mf_notify_client;
